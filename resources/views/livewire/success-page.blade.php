    ...
    <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md md:py-10 md:px-10">
      <div>
          ...
          <div class="flex items-start justify-start flex-shrink-0">
            <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
              <div class="flex flex-col items-start justify-start space-y-2">
                ...
                <p class="text-sm leading-4 cursor-pointer ">Email: {{$order->address->email}}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="flex flex-col w-full space-y-6 ">
              ...
              <div class="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200 ">
                <div class="flex justify-between w-full">
                  ...
                  <p class="text-base leading-4 text-gray-600 ">${{number_format($order->grand_total, 0)}}</p>
                </div>
              ...
              <div class="flex items-center justify-between w-full">
                ...
                <p class="text-base font-semibold leading-4 text-gray-600 ">${{number_format($order->grand_total, 0)}}</p>
              </div>
            </div>
            <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
              ...
              <div class="flex items-start justify-between w-full">
                <div class="flex items-center justify-center space-x-2">
                  <div class="w-8 h-8">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-6 h-6 text-green-600  bi bi-truck" viewBox="0 0 16 16">
                  ...
                  <div class="flex flex-col items-center justify-start">
                    <p class="text-lg font-semibold leading-6 text-gray-800 ">
                      Delivery<br><span class="text-sm font-normal">Delivery with 7 days</span>
                    </p>
                  </div>
                </div>
        ...
        <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
          <a href="/products" class="w-full text-center px-4 py-2 text-green-500 border border-green-500 rounded-md md:w-auto hover:text-white hover:bg-green-600">
            Go back shopping
          </a>
          <a href="/my-orders" class="w-full text-center px-4 py-2 bg-green-500 rounded-md text-gray-50 md:w-auto ">
            View My Orders
          </a>
        </div>
      </div>
